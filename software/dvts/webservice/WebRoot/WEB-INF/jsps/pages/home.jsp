...
<%@ taglib uri="http://struts.apache.org/tags-bean" prefix="bean" %>
	...
	<p>
	<h1>Steps One -- Create a Domain Value Mapping (DVM) File</h1>
	<ul>
	    <li>A DVM file includes domain value mapping information and is essentially needed for this service.</li>
	    ...
	    <li>Unfotunately, caAdapter cannot currently support to creating DVM file but in the future.</li>
		<li>One DVM file is composed of <b>'Domains'</b> such as 'marital status' or 'insurance type'.</li>
		<li>You can see the DVM schema if you click <a target="_blank" href="./xsd/vom.xsd">here</a>.</li>
		<li>You can see an example DVM file if you click <a target="_blank" href="./examples/V2_to_V3.vom">here</a>.</li>
	</ul>
	<h1>Step Two -- Create a DVM Context</h1>
	<p>
	<ul>
		<li>DVM context means a bunch of DVM files shared and managed by one business community or organiztion. </li>
		<li>For using this service, user doesn't have to know each DVM file name, but the context name. </li>
		...
		<li>This service provides a prototype for creating a web based DVM context at <a target="_blank" href="./ManageCaadapterWSUser">here.</a> Please check the 'Installation Guide' document for administrator ID and password. </li>
        <li>After creating your context in this service, you can register your DVM file at <a target="_blank" href="./VOMFileRegistration">here</a>.</li>
    </ul>
	...
	<ul>
        ...
        <ul>
            ...
            <li>Parameter 2 - String context: Context symbolic abbreviation included in the 'contextLinkAddress.properties' file. If not included or the property file is not prepared, this value must be a physical URL or file folder including DVM files. null value not allowed.</li>
