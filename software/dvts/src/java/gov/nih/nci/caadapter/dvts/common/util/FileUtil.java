...
//import gov.nih.nci.caadapter.dvts.hl7.mif.NormativeVersionUtil;
...
//            }
    ...
    public static List<String> getContextAddresses(String filePath)
    {
        ...
        for (int i=0;i<20;i++)
        {
            String p = FileUtil.searchProperty("contextPhysicalAddress" + i);
            if (p == null)
            {
                if (i == 0) continue;
                else break;
        ...
        while (ur != null)
        {
            try
            {
                ...
                while(true)
                {
                    ...
                    {
                        buf = buf.trim();
                        if (!buf.equals("")) contextLine.add(buf);
                        buf = "";
                    }
                    else buf = buf + achar;
                }
