	...
	static {
        ...
        try {
            ...
            if (properties != null) {
            	...
            	//disable all components except GME
    			{
    				ACTIVATED_CAADAPTER_COMPONENTS.clear();
    				ACTIVATED_CAADAPTER_COMPONENTS.add(Config.CAADAPTER_XSD_XMI_MENU_ACTIVATED);
 ...
 * HISTORY      : Revision 1.2  2008/12/19 22:24:38  umkis
