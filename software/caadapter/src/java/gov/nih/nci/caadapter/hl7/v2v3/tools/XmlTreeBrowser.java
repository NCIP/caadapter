 ...
 */
public class XmlTreeBrowser extends JPanel implements ActionListener
{
     ...
     */
    private static final String LOGID = "$RCSfile: XmlTreeBrowser.java,v $";
  ...
  //String dirSeparater;
    public XmlTreeBrowser() //throws HL7MessageTreeException
    {
    ...
    */
    private void constructPanel() throws HL7MessageTreeException
    {
        ...
        {
            throw new HL7MessageTreeException("(XML Browser) Error while setting system look and feel.");
            //return;
        }
 ...
 // }
  ...
  public void actionPerformed(ActionEvent e)
    ...
    public static void main(String arg[])
    {
            ...
            JFrame frame = (new XmlTreeBrowser()).setFrame(new JFrame("XML Browser"));
