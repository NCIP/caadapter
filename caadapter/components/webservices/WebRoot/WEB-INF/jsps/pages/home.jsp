...
<%@ taglib uri="http://struts.apache.org/tags-bean" prefix="bean" %>
	...
	<ul>
		...
		<li>Optionally create a CSV specification file if source data is CSV format: <b>scs</b></li>
		<li>Optionally create one vocabulary mapping file if source is HL7 V2 message: <b>vom</b></li>
	...
	<ul>
		...
		<li>Optionally upload the source specification file if source data is CSV format: <b>scs</b></li>
		<li>Optionally Upload one vocabulary mapping file if source is HL7 V2 message: <b>vom</b></li>
