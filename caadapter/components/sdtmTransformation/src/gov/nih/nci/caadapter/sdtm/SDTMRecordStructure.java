...
public class SDTMRecordStructure {
	...
	// java.lang.reflect.Field[] m = (java.lang.reflect.Field[])Class.forName("harsha.test.SDTMRecord").getDeclaredFields();
	// for ( int g = 0; g< m.length ; g++){
	// System.out.println( m[g].getName());
	//			
	//			
	// if ( m[g].getName().length() > -1 ){
	// return true;
	// }
	// }
	return false;
	...
	String trim = STUDYID + "," + DOMAIN + "," + USUBJID + "," + SUBJID + "," + DM_RFSTDTC + "," + DM_RFENDTC + "," + DM_SITEID + "," + DM_INVID + "," + DM_BRTHDTC + "," + DM_AGE + "," + DM_AGEU + "," + DM_SEX + "," + DM_RACE + "," + DM_ARMCD + "," + DM_ARM + "," + DM_COUNTRY + "," + DM_DM_TC
		+ "," + DM_DMDY;
	return trim;
    }
