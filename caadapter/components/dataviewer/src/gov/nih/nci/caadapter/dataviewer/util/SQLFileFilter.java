...
public class SQLFileFilter extends FileFilter {
     ...
     * @see #addExtension
     */
    public SQLFileFilter(String extension) {
        this(extension, null);
    }
     ...
     * @see #addExtension
     */
    public SQLFileFilter(String extension, String description) {
        this();
        if (extension != null)
     ...
     * @see #addExtension
     */
    public SQLFileFilter(String[] filters) {
        this(filters, null);
    }
     ...
     * @see #addExtension
     */
    public SQLFileFilter(String[] filters, String description) {
        this();
