	...
	static {
        ...
        try {
            ...
            if (properties != null) {
            	...
            	//disable all components except HL7 transformation related
    			{
    				ACTIVATED_CAADAPTER_COMPONENTS.clear();
    				ACTIVATED_CAADAPTER_COMPONENTS.add(Config.CAADAPTER_COMPONENT_HL7_TRANSFORMATION_ACTIVATED);
    				ACTIVATED_CAADAPTER_COMPONENTS.add(Config.CAADAPTER_COMPONENT_HL7_CSV_TRANSFORMATION_ACTIVATED);
    				ACTIVATED_CAADAPTER_COMPONENTS.add(Config.CAADAPTER_COMPONENT_HL7_V2V3_CONVERSION_ACTIVATED);
 ...
 * HISTORY      : Revision 1.1  2008/09/24 15:18:44  wangeug
